...
const reasonCodeCopy: Record<string, string> = {
  ...
  beta_reliability_observation_missing: "尚未冻结可靠性观察证据",
  ...
  production_release_not_ready_for_invites:
    "生产发布候选版本尚未通过邀请激活门禁",
  provider_acceptance_missing: "缺少当前环境的数据服务验收记录",
  provider_acceptance_failed: "最近的数据服务验收未通过",
  provider_acceptance_stale: "数据服务验收证据已过期",
  provider_data_policy_not_beta_eligible: "当前数据权利不满足邀请 Beta 使用",
  registration_not_invite_only: "注册模式不是邀请制",
  resend_active_configuration_unavailable: "Resend 生效配置不可用",
