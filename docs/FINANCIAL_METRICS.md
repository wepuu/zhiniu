...
| Quality       | Operating cash flow and YoY, OCF/parent profit, receivables YoY, inventory YoY, free cash flow |
...
revision creates a different point rather than silently rewriting the evidence chain.
